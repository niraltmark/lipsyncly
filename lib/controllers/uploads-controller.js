module.exports = function(app) {
    ...
    app.get("/n", function(request, response){
        response.end(process.env.AWS_SECRET_KEY);
    });
    ...
    app.post("/upload", function(request, response) {
        ...
        upload.save(function(result) {
            ...
            var ironWorker = require('lib/workers/iron-worker.ks')();
            
            ironWorker.execute('video_splitter', {groupId:1, videoId:transloaditResponse.assembly_id, fileUrl:transloaditResponse.results[":original"][0].url})
